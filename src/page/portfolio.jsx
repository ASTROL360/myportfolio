...
export default function Portfolio() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "Real-time messaging application with secure authentication, live chat functionality, and scalable backend architecture.",
      features: [
      ...
      >
        <div className="max-w-7xl mx-auto w-full">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            {/* Left Content */}
            <div
              className={`transition-all duration-1000 ${isVisible.home ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
            >
              <div className="inline-block mb-6">
                <h2 className="text-2xl text-gray-400 flex items-center gap-2">
                 Hello I Am
                </h2>
              </div>
              ...
              <p className="text-lg text-gray-400 mb-8 max-w-xl leading-relaxed">
                Specializing in <span className="text-white">Java</span>,{" "}
                <span className="text-white">Node.js</span>, and{" "}
                <span className="text-white">database architecture</span> with
                full-stack capabilities. Building scalable backend systems and
            ...
            <div
              className={`relative transition-all duration-1000 delay-300 ${isVisible.home ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
            >
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="space-y-6 text-lg text-gray-400 leading-relaxed">
              <p>
                I'm a motivated software developer currently mastering Full
                Stack Development at the{" "}
                <span className="text-white">
                  National Institute of Information Technology (NIIT)
                </span>{" "}
                in Lagos, Nigeria. My focus lies in building robust, scalable
                backend systems while maintaining the versatility to work across
                the full stack when needed.
              </p>
              <p>
                With expertise in <span className="text-white">Java</span> and{" "}
                <span className="text-white">Node.js</span>, I specialize in
                creating efficient backend architectures, designing database
                schemas, and developing RESTful APIs that power modern
                applications. I'm passionate about clean code, system design,
                and solving complex technical challenges.
              </p>
              <p>
                Beyond coding, I'm learning to play the saxophone and exploring
                3D modeling and animation—creative pursuits that complement my
                technical work and keep my problem-solving skills sharp.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="skills" className="relative py-32 px-6 bg-white/5">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid gap-12">
            ...
            {/* Databases */}
            <div
              className={`transition-all duration-1000 delay-100 ${isVisible.skills ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
            >
              <div className="flex items-center gap-3 mb-6">
      ...
      <section id="projects" className="relative py-32 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-gray-400 mb-16 text-lg">
            A collection of my recent work showcasing backend development and
                ...
                >
                  <div className="relative p-8 md:p-10 bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl hover:bg-white/10 hover:border-white/20 transition-all duration-300">
                    <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-6">
                      ...
                      <span
                        className={`px-4 py-2 border rounded-md text-sm font-medium whitespace-nowrap ${statusInfo.color}`}
                      >
                        {statusInfo.text}
                      </span>
                    </div>
